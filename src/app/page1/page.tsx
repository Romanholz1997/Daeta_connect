...
const Home: React.FC = () => {
    return (
        <div className='container mx-auto'>
            <div className='absolute top-0 left-0 w-full h-full bg-cover z-[1]' style={{ backgroundImage: `url('./assets/background.png')` }}>
            </div>
            <MatrixRain />
            ...
            <div className='max-w-[1000px] mx-auto flex flex-col p-5 md:flex-row justify-between space-x-0 md:space-x-14 mt-10 md:mt-[120px] z-[600]'>
                <div className='border border-[#F7FF9A] border-opacity-50 rounded-xl flex-col items-center justify-center w-full mt-5  z-[600]'>
                    ...
                    <button type='button' className='flex w-full border-t-[#F7FF9A] border-t border-opacity-50 items-center justify-center space-x-2 p-5 bg-[#191919] rounded-b-xl h-1/4'>
                        <p className='font-bold text-[21px] text-[#F7FF9A] font-mono hover:scale-105'>READ MORE </p>
                        <FontAwesomeIcon icon={faArrowRight} className="text-[#F7FF9A] text-[20px]" />
                    </button>
                </div>
                <div className='border border-[#F7FF9A] border-opacity-50 rounded-xl flex-col justify-center w-full mt-5  z-[600]'>
                    ...
                    <button type='button' className='flex w-full border-t-[#F7FF9A] border-t border-opacity-50 items-center justify-center space-x-2 p-5 bg-[#191919] rounded-b-xl h-1/4'>
                        <FontAwesomeIcon icon={faWallet} className="text-[#F7FF9A] text-[25px]" />
                        <p className='font-bold text-[21px] text-[#F7FF9A] font-mono hover:scale-105'>CONNECT WALLET</p>
                    </button>
                </div>
            </div>
